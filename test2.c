...
int main(){
  ...
  printf("Initialized module t = %d, c = %d, w.size = %d, input = %d, output = %d, bprop = %d, fprop = %d, randomize = %d, destroy = %d\n",
	 (int)m.t, (int)m.c, (int)m.w.size, (int)m.input, (int)m.output, (int)m.bprop, (int)m.fprop, (int)m.randomize, (int)m.destroy);
